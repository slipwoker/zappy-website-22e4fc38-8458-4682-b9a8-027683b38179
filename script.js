document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field) {
      ...
      if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
        return fieldLabel + ' must not exceed ' + field.maxLength + ' characters.';
      }
  ...
  const ANIMATE_SELECTOR = '.animate-on-scroll, [data-animate], .fade-in';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '22e4fc38-8458-4682-b9a8-027683b38179',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '22e4fc38-8458-4682-b9a8-027683b38179';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '22e4fc38-8458-4682-b9a8-027683b38179';
